...
<div class="login-box">
  ...
  <div class="login-box-body"> 
    ...
    <form action="" method="post">
	  ...
	  <div class="form-group has-feedback">
        <input type="password" class="form-control input_num" placeholder="OTP" name="otp" value="<?php echo set_value("otp");?>" minlength="4" maxlength="4">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
		<div class="text-red"><?php echo form_error("otp");?></div>
      </div> 
      <div class="row">
        <div class="col-sm-6 col-sm-offset-3">
          <button type="submit" class="btn btn-primary btn-block btn-flat" name="submit" value="Sign In">Log In</button>
        </div>
        <!-- /.col -->
      </div>
    </form>  
