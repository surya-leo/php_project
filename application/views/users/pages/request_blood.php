			...
			<form method="post" action="">
				<div class="box-body">
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label>Hospital Name <span class="text-red">*</span></label>
								<input type="text" class="form-control" name="hospi_name" value="<?php echo set_value('hospi_name');?>" placeholder="Hospital Name"> 
								<div class="text-red"><?php echo form_error("hospi_name");?></div> 
							</div>  
						</div>
						<div class="col-md-6"> 
